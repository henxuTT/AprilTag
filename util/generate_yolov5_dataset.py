...
def transform_img(base_img_path, tag_img, tag_class, start_idx, num, img_output_path, label_output_path):
    x1 = 0
    y1 = 0
    x2 = tag_img.shape[1] - 1
    y2 = tag_img.shape[1] - 1
    ...
    for file in files:
        ...
        for i in range(num):
            ...
            dst_points = np.float32(
                [[a1 * x1, a2 * y1], [(1 - a3) * x2, a4 * y1], [(1 - a5) * x2, (1 - a6) * y2],
                 [a7 * x1, (1 - a8) * y2]])
            ...
            # 进行透视变换，获取四边形
            dst = cv2.warpPerspective(tag_img, M, (0, 0))
            ...
            output_image = img_output_path + str(cls) + '_' + f'{index:04d}.jpg'
            output_label = label_output_path + str(cls) + '_' + f'{index:04d}.txt'
...
img_05 = cv2.imread('../images/apriltag_origin/tag36_11_00005.jpg')
img_07 = cv2.imread('../images/apriltag_origin/tag36_11_00007.jpg')
img_36 = cv2.imread('../images/apriltag_origin/tag36_11_00036.jpg')
img_39 = cv2.imread('../images/apriltag_origin/tag36_11_00039.jpg')

output_image_path = '../VOCdevkit/images/train/'
output_label_path = '../VOCdevkit/labels/train/'

transform_img(base_img_path, img_05, 0, 1, 200, output_image_path, output_label_path)
transform_img(base_img_path, img_07, 1, 2001, 200, output_image_path, output_label_path)
transform_img(base_img_path, img_36, 2, 4001, 200, output_image_path, output_label_path)
transform_img(base_img_path, img_39, 3, 6001, 200, output_image_path, output_label_path)